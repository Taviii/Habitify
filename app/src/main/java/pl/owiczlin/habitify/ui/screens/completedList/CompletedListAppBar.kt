...
import pl.owiczlin.habitify.ui.screens.list.defaultListAppBar
import pl.owiczlin.habitify.ui.screens.list.deleteAllAction
import pl.owiczlin.habitify.ui.screens.list.searchAppBar
...
@Composable
fun defaultCompletedListAppBar(
    ...
    TopAppBar(
        title = {
            Text(
                text = stringResource(id = R.string.completed_list_screen_title),
                color = MaterialTheme.colors.topAppBarContentColor
            )
        },
        actions = {
            completedListAppBarActions(
...
@Composable
fun completedBottomNavigationBar(
    ...
    BottomNavigation(
        ...
        BottomNavigationItem(
            ...
            label = { Text(stringResource(id = R.string.completed_quests_list)) }
        )
...
@Composable
fun completedListAppBarActions(
    onSearchClicked: () -> Unit,
    onSortClicked: (Priority) -> Unit,
    onDeleteAllConfirmed: () -> Unit
) {
    ...
    completedSearchAction(onSearchClicked = onSearchClicked)
    completedSortAction(onSortClicked = onSortClicked)
    deleteAllAction(
...
@Composable
@Preview
private fun completedDefaultListAppBarPreview() {
    defaultListAppBar(
        onSearchClicked = {},
        onSortClicked = {},
        onDeleteAllConfirmed = {}
...
@Composable
@Preview
private fun completedSearchAppBarPreview() {
    searchAppBar(text = "",
        onTextChange = {},
        onCloseClicked = {},
        onSearchClicked = {})
...
@Composable
@Preview
private fun completedBottomNavigationBarPreview() {
